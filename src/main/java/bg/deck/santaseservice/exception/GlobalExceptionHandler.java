...
import static bg.deck.santaseservice.constant.Constants.X_REAL_IP;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleSecurityAndBusinessExceptions(RuntimeException ex, HttpServletRequest request) {
        log.warn(ExceptionConstants.LOG_FORMAT_SECURITY, ex.getMessage(), request.getHeader(X_REAL_IP), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCredentialsException(InvalidCredentialsException ex, HttpServletRequest request) {
        log.warn(LOG_FORMAT_SECURITY, ex.getMessage(), request.getHeader(X_REAL_IP), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidToken(InvalidTokenException ex, HttpServletRequest request) {
        log.error(ExceptionConstants.LOG_FORMAT_SECURITY, ex.getMessage(), request.getHeader(X_REAL_IP), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception ex, HttpServletRequest request) {
        log.error(ExceptionConstants.LOG_FORMAT_UNHANDLED, request.getHeader(X_REAL_IP), request.getRequestURI(),
