...
import bg.deck.enums.card.Suit;
import bg.deck.exception.CardNotFoundException;
import bg.deck.exception.CardNotPlayableException;
import bg.deck.exception.DeckSizeException;
import bg.deck.exception.InvalidCredentialsException;
import bg.deck.exception.NoActiveGameFoundException;
import bg.deck.exception.NotFirstInTurnException;
import bg.deck.exception.NotInTurnException;
...
import static bg.deck.constant.Constants.KING;
import static bg.deck.constant.Constants.QUEEN;
